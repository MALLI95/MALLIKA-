...
?barplot
barplot(height =c(10,15,25,50))
barplot(c(19,34), col = 5:3)
...
barplot(height=table(df$am),col = c('red','blue'))
...
barplot(counts, main="Car Distribution by Gears and VS",  xlab="Number of Gears", col=c("darkgreen","yellow"),  legend = rownames(counts), beside=TRUE)

# Stacked Bar Plot with Colors and Legend ----
counts <- table(df$vs, df$gear)
barplot(counts, main="Car Distribution by Gears and VS", xlab="Number of Gears", col=c("yellow","black"),  legend = rownames(counts))
